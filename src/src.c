...
#define MARGINLEFT 5
#define MARGINRIGHT 33
#define R_BOUNDARY 9
#define C_BOUNDARY 9
#define MINES_DEPLOYED 10
#define SIZE_OF_BOX 32 // in pixels
#define WIDTH_TIMERBOX 32 //13
#define HIGHT_TIMERBOX  32 //23
#define WIDTH_SMILEY 32 //25
#define HIGHT_SMILEY 32 //23
...
int main()
{
	...
	loadimg = SDL_LoadBMP("../resources/nexttest.bmp");
	...
	SDL_FillRect(screen, NULL, SDL_MapRGB(screen->format, 6, 255, 0));
	InitAllsquare();
